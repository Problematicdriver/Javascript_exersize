...
// #4a
console.log("Hello, My name is JIAYI GUO");
...
// #7m
console.log("The type of 'Null' is: " + typeof(False));
...
// #8f
console.log("The final total is :" + total + " when the starting value are 'foo' : " + foo + " and 'bar' : " + bar)
